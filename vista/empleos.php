...
<body data-spy="scroll" data-target=".inner-link" data-offset="60">
        ...
        <nav class="navbar navbar-expand-lg">
          ...
          <div
           ...
           <ul class="navbar-nav fs-0 fw-700">
              ...
              <li>
                <a href="services.html">empleos</a> 
              </li>
              <li>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-10 col-md-6">
            <h3 class="color-primary fs-2 fs-lg-3">Perfil del personal</h3>
            <p class="px-lg-4 mt-3">El personal de vigilancia reúne como mínimo los siguientes requisitos:</p>
        ...
        <div class="row mt-4 mt-md-5">
          <div class="col-sm-6 col-lg-3 mt-4" data-zanim-timeline='{"delay":0.1}' data-zanim-trigger="scroll">
            ...
            <h5 class="mt-4" data-zanim='{"delay":0.1}'>Estudios</h5>
            <p class="mb-0 mt-3 px-3" data-zanim='{"delay":0.2}'>NIVEL DE ESTUDIO BACHILLER</p>
          </div>
          <div class="col-sm-6 col-lg-3 mt-4" data-zanim-timeline='{"delay":0.1}' data-zanim-trigger="scroll">
            ...
            <h5 class="mt-4" data-zanim='{"delay":0.1}'>Edad</h5>
            <p class="mb-0 mt-3 px-3" data-zanim='{"delay":0.2}'>EDAD DE 20 A 45  AÑOS</p>
          </div>
          <div class="col-sm-6 col-lg-3 mt-4" data-zanim-timeline='{"delay":0.1}' data-zanim-trigger="scroll">
            ...
            <h5 class="mt-4" data-zanim='{"delay":0.1}'>Presentacion</h5>
            <p class="mb-0 mt-3 px-3" data-zanim='{"delay":0.2}'>EXCELENTE PRESENTACIÓN PERSONAL</p>
          </div>
          <div class="col-sm-6 col-lg-3 mt-4" data-zanim-timeline='{"delay":0.1}' data-zanim-trigger="scroll">
            ...
            <h5 class="mt-4" data-zanim='{"delay":0.1}'>Expresion</h5>
            <p class="mb-0 mt-3 px-3" data-zanim='{"delay":0.2}'>FACILIDAD DE EXPRESIÓN</p>
          </div>
          <div class="col-sm-6 col-lg-3 mt-4" data-zanim-timeline='{"delay":0.1}' data-zanim-trigger="scroll">
            <div class="background-11 border border-color-9 radius-round mx-auto d-flex align-items-center" data-zanim='{"trigger":"scroll"}' style="height:100px; width:100px;"><span class="icon-Headset fs-3 color-blueish mx-auto fw-600"></span></div>
            <h5 class="mt-4" data-zanim='{"delay":0.1}'>Experencia</h5>
            <p class="mb-0 mt-3 px-3" data-zanim='{"delay":0.2}'>EXPERIENCIA EN EL MANEJO DE PERSONAL</p>
          </div>
          <div class="col-sm-6 col-lg-3 mt-4" data-zanim-timeline='{"delay":0.1}' data-zanim-trigger="scroll">
            <div class="background-11 border border-color-9 radius-round mx-auto d-flex align-items-center" data-zanim='{"trigger":"scroll"}' style="height:100px; width:100px;"><span class="icon-Headset fs-3 color-blueish mx-auto fw-600"></span></div>
            <h5 class="mt-4" data-zanim='{"delay":0.1}'>Toma de decisiones</h5>
            <p class="mb-0 mt-3 px-3" data-zanim='{"delay":0.2}'>CAPACIDAD PARA TOMA DE DECISIONES</p>
          </div>
          <div class="col-sm-6 col-lg-3 mt-4" data-zanim-timeline='{"delay":0.1}' data-zanim-trigger="scroll">
            <div class="background-11 border border-color-9 radius-round mx-auto d-flex align-items-center" data-zanim='{"trigger":"scroll"}' style="height:100px; width:100px;"><span class="icon-Idea-2 fs-3 color-blueish mx-auto fw-600"></span></div>
            <h5 class="mt-4" data-zanim='{"delay":0.1}'>Presentacion</h5>
  ...
  <section class="background-11">
      <div class="container">
        <div class="row mt-6">
          <div class="col">
            <h3 class="text-center fs-2 fs-md-3">Beneficios de nuestros empleados</h3>
            <hr class="short" data-zanim='{"from":{"opacity":0,"width":0},"to":{"opacity":1,"width":"4.20873rem"},"duration":0.8}'
              data-zanim-trigger="scroll" />
          </div>
          <div class="col-12">
            <div class="background-white px-3 mt-6 px-0 py-5 px-lg-5 radius-secondary">
              <p class="column-lg-2 dropcap">
                A continuación relaciono las ventajas que tiene nuestros guardas de seguridad, 
                en la prestación del servicio:
                <ul>
                  <li>pertenecer a una empresa legal</li>
                  <li>iniciar su profesionalización en seguridad</li>
                  <li>convertirse en competente laboral en seguridad por el sena.</li>
                  <li>un salario justo y acorde a la profesión.</li>
                  <li>estabilidad laboral.</li>
                  <li>capacitación continua.</li>
                  <li>liquidación anual de aportes sociales.</li>
                  <li>primas en julio y diciembre</li>
                  <li>dotacion de uniformes</li>
                  <li>derecho a recreación adicional en club privado de la organización.</li>
                  <li>descanso remunerado el dia de cumpleaños.</li>
                  <li>incentivo al ahorro en el fondo de vigilantes fvcc.</li>
                  <li>permiso para formación profesional.</li>
                  <li>mayor número de descanso y mejor salario.</li>
                  <li>contar con apoyo de supervisión radial y movil en caso de eventos.</li>
                  <li>derecho a reconocimientos por excelencia en el servicio.</li>
                  <li>inclusion en los planes de responsabilidas social.</li>
                  <li>kids escolar en el mes de febrero por pertenecer al fondo de ahorro.</li>
                  <li>prestamos a bajo interes (0,65%) mensual.</li>
                  <li>celebración dia del guarda en noviembre y derecho a regalo.</li>
