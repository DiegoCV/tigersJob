          ...
          <div class="col-lg-6 px-lg-5 mt-6 mt-lg-0" data-zanim-timeline="{}"
            ...
            <div class="overflow-hidden">
              <div class="px-4 px-sm-0 mt-5" data-zanim='{"delay":0.1}'>
                ...
                <p class="mt-3 px-lg-3">With so many factors to consider when deciding how to characterize your company , wouldn’t it be great to have a group of forward-thinking,
            ...
            <div class="overflow-hidden">
              <div class="px-4 px-sm-0 mt-5" data-zanim='{"delay":0.2}'>
                ...
                <p class="mt-3 px-lg-3">Design clever and compelling marketing strategies, improve product positioning, and drive conversion rates, Elixir is all time available
                  to guide you.</p>
              </div>
            </div>
          </div>
    ...
    <section class="background-11">
      <div class="container">
        <div class="row text-center">
          <div class="col">
            <h3 class="fs-2 fs-md-3 fw-600">Industries</h3>
