  ...
  <!--<section >-->
      <div class="box" style="width: 100%; height: 400; background-image: url(vista/assets/images/contacto/mostaza.jpg ) ; background-attachment: fixed;">
        ...
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="background-primary color-white p-5 p-lg-6 radius-secondary">
              <h4 class="color-white fs-1 fs-lg-2 mb-1">Regístrese para recibir alertas por correo electrónico</h4>
              <p class="color-white">Manténgase actualizado con nuestras últimas ideas</p>
              <form class="mt-4">
                <div class="row align-items-center">
            ...
            <div class="row">
              <div class="col-6 col-lg-4 color-white ml-lg-auto">
                <ul class="list-unstyled">
                  <li class="mb-3"><a class="color-white" href="#">Contactenos</a></li>
                  <li class="mb-3"><a class="color-white" href="#">Preguntas más frecuentes</a></li>
                  <li class="mb-3"><a class="color-white" href="#">Política de privacidad</a></li>
                  <!--<li class="mb-3"><a class="color-white" href="#">Terms of Use</a></li>-->
                  <li class="mb-3"><a class="color-white" href="#">Oficinas</a></li>
    ...
    <!--</section>-->
        ...
        <div style="background-color: #3D4C6F" class="row align-items-center" style="opacity: 0.85;">
           
          <div >
               <br>
            <p class="color-white lh-6 mb-0 fw-600">&copy; Copyright 2018 Inc.</p>
            <br>
          </div>
