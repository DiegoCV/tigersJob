<!DOCTYPE html>
<html lang="en-US">
   <!-- Mirrored from markup.themewagon.com/tryelixir/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jul 2018 00:07:12 GMT -->
   <head>
      <meta charset="utf-8">
      ...
      <link href=<?php $this->way->ruta("assets/lib/iconsmind/iconsmind.css")?> rel="stylesheet">
      <link href="../../code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css" rel="stylesheet">
      <link href=<?php $this->way->ruta("assets/lib/hamburgers/dist/hamburgers.min.css")?> rel="stylesheet">
      <link href=<?php $this->way->ruta("assets/lib/font-awesome/css/font-awesome.min.css")?> rel="stylesheet">
      <!-- Main stylesheet and color file-->
      <link href=<?php $this->way->ruta("assets/css/style.css")?> rel="stylesheet">
      <link href=<?php $this->way->ruta("assets/css/custom.css")?> rel="stylesheet">
   </head>
   <body data-spy="scroll" data-target=".inner-link" data-offset="60">
      <main>
         ...
         <section class="text-center py-0">
            <div class="background-holder overlay overlay-2" style="background-image:url(vista/assets/images/header-5.jpg);"></div>
            <!--/.background-holder-->
            <div class="container">
               <div class="row h-full align-items-center">
                  <div class="col-md-8 col-lg-5 mx-auto" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                     <div data-zanim='{"delay":0}'><a href="index-2.html"><img src="vista/assets/images/logo-light.png" alt=""/></a></div>
                           ...
                           <div class="row align-items-center">
                              <div class="col-12">
                                 <div class="input-group">
                                    <div class="input-group-addon background-11 fs-2"><span class="ion-ios-person-outline"></span></div>
                                    <input class="form-control" type="text" placeholder="Email or username" aria-label="Text input with dropdown button"/>
                                 </div>
                              </div>
                              <div class="col-12 mt-2 mt-sm-4">
                                 <div class="input-group">
                                    <div class="input-group-addon background-11 fs-2"><span class="ion-ios-locked-outline"></span></div>
                                    <input class="form-control" type="Password" placeholder="Password" aria-label="Text input with dropdown button"/>
                                 </div>
                              </div>
                           </div>
                           <div class="row align-items-center mt-3">
                              <div class="col-6"><label class="form-check-label"><input class="form-check-input" type="checkbox"/><span class="color-7">Remember Me</span></label></div>
                              <div class="col-6 mt-2 mt-sm-3"><button class="btn btn-primary btn-block" type="submit">Login</button></div>
                           </div>
                        </form>
                     </div>
                  </div>
      ...
      <script src="vista/assets/js/zanimation.js"></script><!-- Hotjar Tracking Code for http://markup.themewagon.com/tryelixir--><script>(function(h,o,t,j,a,r){
