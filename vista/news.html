         ...
         <div class="znav-white znav-container sticky-top navbar-elixir" id="znav-container">
            <div class="container">
               <nav class="navbar navbar-expand-lg">
                  <a class="navbar-brand overflow-hidden pr-3" href="index-2.html"><img src="assets/images/logo-dark.png" alt=""/></a>
                           ...
                           <div class="row mt-6">
                                 ...
                                 <div class="background-white p-5 radius-tl-secondary radius-tr-secondary">
                                    ...
                                    <div class="row my-5">
                                       ...
                                       <div class="col-10">
                                          ...
                                          <a class="d-block my-3 text-right mr-4" href="#">Reply</a>
                                          <hr class="muted">
                                          <div class="row my-4">
                                             ...
                                             <div class="col-10">
                                                <h5 class="mb-1">Post Heading</h5>
                                                <p class="fs--1 color-7">May 15, 2017 at 9:33 am</p>
                                                <p>Writing case studies was a daunting task for us. We didn’t know where to begin or what questions to ask, and clients never seemed to follow through when we asked. Elixir team did everything – with almost no time or effort for me!</p>
                                                <a class="d-block my-3 text-right mr-4" href="#">Reply</a>
                                             </div>
                                          </div>
                                          <hr class="muted">
                                    ...
                                    <div class="row my-4">
                                       ...
                                       <div class="col-10">
                                          <h5 class="mb-1">Post Heading</h5>
                                          <p class="fs--1 color-7">May 15, 2017 at 9:33 am</p>
                                          <p>As a sales gamification company, we were skeptical to work with a consultant to optimize our sales emails, but Elixir was highly recommended by many other Y-Combinator startups we knew. Elixir helped us run a ~6 week email campaign that brought us more leads than we had ever seen for a single effort.</p>
                                          <a class="d-block my-3 text-right mr-4" href="#">Reply</a>
                                          <hr class="muted">
                                       </div>
                                    </div>
                              ...
                              <div class="col-12">
                                 <div class="background-white p-5 radius-bl-secondary radius-br-secondary">
                                    ...
                                    <form class="mt-4">
                                       <div class="row">
                                          <div class="col-12"><input class="form-control background-white" type="text" placeholder="Your Name" aria-label="Text input with dropdown button"></div>
                                          <div class="col-12 mt-4"><input class="form-control background-white" type="email" placeholder="Email" aria-label="Text input with dropdown button"></div>
                                          <div class="col-12 mt-4"><textarea class="form-control background-white" rows="10" placeholder="Leave your comment here..." aria-label="Text input with dropdown button"></textarea></div>
                                          <div class="col-12 mt-4"><button class="btn btn-primary" type="Submit"> <span class="color-white fw-600">Submit Comment</span></button></div>
                                       </div>
                                    </form>
                                 </div>
                              </div>
         ...
         <section class="background-primary text-center py-4">
            <div class="container">
               <div class="row align-items-center" style="opacity: 0.85;">
                  <div class="col-sm-3 text-sm-left"><a href="index-2.html"><img src="assets/images/logo-light.png" alt=""/></a></div>
